...
class admineditcategory extends StatefulWidget{
  ...
  State<StatefulWidget> createState() {
    return admineditcategorystate();
  }

}
class admineditcategorystate extends State<admineditcategory> {
  @override
  void initState() {
  ...
  Pro ()async{
    ...
    var res=await http.put(Uri.parse('https://golami.paas.torphin.com/api/Categories'),headers: {"Content-Type": "application/json"},body:body);
